...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
         ...
         KC_LSFT, KC_NO,   KC_APP,  BL_STEP,KC_NO,  KC_NO,  KC_VOLD,KC_VOLU,KC_MUTE, KC_END,  KC_PGDN,  KC_RSFT, KC_PGUP, \
         KC_LCTL, KC_LGUI, KC_LALT,                          KC_SPC,                 F(0),     KC_HOME, KC_PGDOWN,KC_END),
